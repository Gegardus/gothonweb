...
class TestGame < Test::Unit::TestCase
  ...
  def test_room
    gold = Map::Room.new("GoldMap::Room", """This room has gold in it""")
  ...
  def test_map
    start = Map::Room.new("Start", "You can go west or down a hole.")
    west = Map::Room.new("Trees", "There are trees, but you can go east.")
